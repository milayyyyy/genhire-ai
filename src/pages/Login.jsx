          ...
          <div style={{
            ...
            <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
              ...
              <p style={{
                ...
                Access your personalized interview coach and start improving today!
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <label style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', cursor: 'pointer', fontSize: '0.9rem', color: '#94a3b8' }}>
                  <input type="checkbox" checked={rememberMe} onChange={(e) => setRememberMe(e.target.checked)} style={{ accentColor: '#00c6ff', width: '16px', height: '16px' }} />
                  Remember me
                </label>
                <button type="button" onClick={onForgotPassword} style={{ background: 'none', border: 'none', color: '#00c6ff', fontSize: '0.9rem', fontWeight: '600', cursor: 'pointer' }}>
                  Forgot password?
                </button>
              </div>
